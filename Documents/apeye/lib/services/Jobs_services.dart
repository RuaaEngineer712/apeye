...
class Jobs_services{
  ...
  Future<List<Jobs>> fetchJobs() async{    
    try{
      var jobUrl  = Uri.parse('https://customsearch.googleapis.com/customsearch/v1?cx=931e438f39f6499c6&exactTerms=engineer&key=AIzaSyCC9TrOYMA6FKhBrd57u113aRIfoy2iDEQ');
  ...
  // Future<bool> fetchOrNot async(List<Jobs_model> news_list){
  //   try{
  //     fetchNews();
  //     if(response.statusCode == 200)
  //   }
